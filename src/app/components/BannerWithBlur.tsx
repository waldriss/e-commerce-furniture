...
const BannerWithBlur = () => {
  return (
    <section className='relative w-full h-[500px] bg-cover bg-center bg-fixed flex justify-center items-center flex-col mt-16 mb-24 ' style={{ backgroundImage: `url(${sales_img.src})`}} >
        ...
        <Link className='z-[3] mt-5 bg-[#A37A74] text-white font-sans tracking-wider no-underline px-5 py-3 smcart:px-4 font-thin text-xl rounded-[3px] border-[#A37A74] border-solid border-[1px] ' href=""> Explore </Link>
